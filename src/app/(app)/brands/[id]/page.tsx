...
export default function BrandDetailPage() {
  ...
  return (
    <main className="app-page brand-desk">
      <p className="brand-desk__crumb">
        <Link href="/brands" className="muted" style={{ fontWeight: 600 }}>
          ← Brands
        </Link>
      </p>
      ...
      <header className="brand-desk__hero">
        ...
        <div className="brand-desk__hero-row">
          ...
          <div className="brand-desk__identity">
            <p className="brand-desk__eyebrow">Brand desk</p>
            ...
            <div className="brand-desk__actions">
              ...
              {canEdit ? (
                ...
                >
                  {showSettings ? 'Close settings' : 'Edit brand'}
                </button>
              ) : null}
            </div>
      ...
      {showSettings && canEdit ? (
        <section className="brand-section brand-section--settings" aria-labelledby="brand-settings">
          ...
          <p className="brand-section__lead">
            Logo URL (https or site path like <code>/brands/nike.svg</code>) and public description.
          </p>
          <div className="brand-settings-grid">
            ...
            <label className="brand-field">
              ...
              <input
                ...
                placeholder="https://… or /brands/nike.svg"
              />
            </label>
          ...
          <div className="brand-desk__actions" style={{ marginTop: '0.85rem' }}>
            ...
            {!editLogo.trim() && brand.slug === 'nike' ? (
              <button
                type="button"
                className="btn-ghost"
                onClick={() => setEditLogo('/brands/nike.svg')}
              >
                Use built-in Nike mark
              </button>
            ) : null}
          </div>
        </section>
