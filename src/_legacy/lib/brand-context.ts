...
export function resolveSelectedBrand(
  ...
  // Stable default: oldest brand. Callers often pass createdAt-desc lists where
  // brands[0] is the newest (often an empty duplicate like nike-2).
  return brands[brands.length - 1] || brands[0];
}
